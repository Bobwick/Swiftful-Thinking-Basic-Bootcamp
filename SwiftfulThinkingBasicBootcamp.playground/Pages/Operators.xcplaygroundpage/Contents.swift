...
if likeCount > 3 && commentCount > 0 {
    print("Post has greater than 3 likes and greather than 0 comments")
} else {
    print("Post has 3 or less likes OR post has 0 less comments.")
}

if likeCount > 3 || commentCount > 0 {
    print("Post has greather than 3 like OR greather than 0 comments.")
} else {
